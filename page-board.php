  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        ...
        <!-- Profiles Grid -->
        <?php
          // Get profiles for board-member level only
        ...
        <div class="profile-level-section mb-5">
          ...
          <div class="board-bio-list">
            ...
            <div
              ...
              data-id="board-member-<?php echo $profile_index; ?>">
              <?php if ($email || $strava) : ?>
            ...
            <div id="board-member-<?php echo $bio_index; ?>" class="bio-details bio-details-<?php echo $bio_index; ?>"
              style="display: none">
