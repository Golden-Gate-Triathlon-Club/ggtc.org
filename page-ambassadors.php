  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        ...
        <!-- Profiles Grid -->
        <?php
          // Get profiles for ambassador level only
        ...
        <div class="profile-level-section mb-5">
          ...
          <div class="board-bio-list">
            ...
            <div class="card bio-card bio-card-<?php echo $profile_index; ?>"
              data-id="ambassadors-<?php echo $profile_index; ?>">
              <?php if ($email || $strava) : ?>
            ...
            <div id="ambassadors-<?php echo $bio_index; ?>" class="bio-details bio-details-<?php echo $bio_index; ?>"
              style="display: none">
